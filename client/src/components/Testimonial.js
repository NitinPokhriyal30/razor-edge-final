...
const Testimonial = () => {
  ...
  useEffect(() => {
    axios
      .get("https://razor-edge-app.herokuapp.com/testimonial")
            ...
            <div className="container">
              <div className="row">
                <div className="col-md-6 text-center why-us-testi-img-container">
                  <img
                    src={`https://razor-edge-app.herokuapp.com/images/${value.img}`}
                    className={value.img}
                    alt={value.img}
                  />
                </div>
                <div className="col-md-6 m-auto">
                  <div className="carousel-caption" id="testomonial-txt">
                    <img
                      src={`https://razor-edge-app.herokuapp.com/images/quote.png`}
