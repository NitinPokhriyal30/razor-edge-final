...
const AdminSingleBlogPage = () => {
  ...
  useEffect(() => {
    const getBlog = async () => { 
      const res = await Axios.get("https://razor-edge-app.herokuapp.com/blogs-get/" + id); 
      setBlog(res.data);
  ...
  const updateData = async () => {
    ...
    Axios.put(`https://razor-edge-app.herokuapp.com/blogs-get/${blog._id}`, formData);  
    navigate("/admin-blogs");
  };

  const deleteBlog = () => {
    Axios.delete(`https://razor-edge-app.herokuapp.com/blogs-get/${blog._id}`);
    navigate("/admin-blogs");
  };
