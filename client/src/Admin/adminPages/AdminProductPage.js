...
const AdminProductPage = () => {
  ...
  useEffect(() => {
    const get = async () => {
      const res = await Axios.get(
        `https://razor-edge-app.herokuapp.com/product-get/product/${id}`
      );
      setKey(res.data._id);
  ...
  const updateData = async (e) => {
    ...
    await Axios.put(
      "https://razor-edge-app.herokuapp.com/product-update",
      formData
    );
  ...
  //   await Axios.put("https://razor-edge-app.herokuapp.com/product-update", data);
  //   window.location.reload();
  ...
  //     proSecondBullets: proSecondBullets1,
  //   };
  //   Axios.put(`https://razor-edge-app.herokuapp.com/product-update/${key}`, newdata).then(
  ...
  //   };
  //   await Axios.put(
  //     `https://razor-edge-app.herokuapp.com/product-update/${key}`,
  //     newdata
  //   );
  ...
  const deleteData = (e) => {
    Axios.delete(`https://razor-edge-app.herokuapp.com/product-delete/${key}`);
    navigate("/admin-dashboard");
  };
              ...
              <div className="col-lg-6 col-md-6">
                <div className="integration-img-container">
                  {update ? (
                    ...
                    <img
                      src={`https://razor-edge-app.herokuapp.com/images/${proFirstImage1}`}
                      className="VideoImg"
                      alt="VideoImg"
                    />
                  )}
              ...
              <div className=" col-lg-6 col-md-6 integration-data-col">
                <div className="bullet-img-sec">
                  {update ? (
                    ...
                    <img
                      src={`https://razor-edge-app.herokuapp.com/images/${proSecondImage1}`}
                      className="VideoImg"
                      alt="VideoImg"
                    />
                  )}
              ...
              <div className=" col-lg-6 col-md-6 pb-3 integration-data-col">
                <div className="bullet-img-sec">
                  {update ? (
                    ...
                    <img
                      src={`https://razor-edge-app.herokuapp.com/images/${proThirdImage1}`}
                      className="VideoImg"
                      alt="VideoImg"
                    />
                  )}
              ...
              <div className="col-md-3 py-3">
                <div className="product-first-img">
                  {update ? (
                    ...
                    <img
                      src={`https://razor-edge-app.herokuapp.com/images/${proFourthCards1img1}`}
              ...
              <div className="col-md-3 py-3">
                <div className="product-first-img">
                  {update ? (
                    ...
                    <img
                      src={`https://razor-edge-app.herokuapp.com/images/${proFourthCards2img1}`}
              ...
              <div className="col-md-3 py-3">
                <div className="product-first-img">
                  {update ? (
                    ...
                    <img
                      src={`https://razor-edge-app.herokuapp.com/images/${proFourthCards3img1}`}
              ...
              <div className="col-md-3 py-3">
                <div className="product-first-img">
                  {update ? (
                    ...
                    <img
                      src={`https://razor-edge-app.herokuapp.com/images/${proFourthCards4img1}`}
