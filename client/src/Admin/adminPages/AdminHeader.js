...
const AdminHeader = () => {
  ...
  useEffect(() => {
    Axios.get("https://razor-edge-app.herokuapp.com/header").then((res) =>
      setHeader(res.data)
    );
    ...
    Axios.get("https://razor-edge-app.herokuapp.com/solution1-get").then((res) =>
      setSolution1Pages(res.data)
    );

    Axios.get("https://razor-edge-app.herokuapp.com/product-get").then((res) =>
          ...
          <div className="container">
            <div className="logo-container-sec ">
              <Link to="/admin-dashboard">
                <img
                  src={`https://razor-edge-app.herokuapp.com/images/${value.logo}`}
                  // src={NavLogo}
                  className="NavLogo"
                  alt="NavLogo"
                />
