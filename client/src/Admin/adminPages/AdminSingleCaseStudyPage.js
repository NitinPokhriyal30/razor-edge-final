...
const AdminSingleCaseStudyPage = () => {
  ...
  const convertContentToHTML = () => {
    ...
    useEffect(() => {
        ...
        const res = await Axios.get("https://razor-edge-app.herokuapp.com/case-studies-get/" + id );
  ...
  const updateData = async () => {
    ...
    Axios.put(
      `https://razor-edge-app.herokuapp.com/case-studies-get/${caseStudy._id}`,
      formData
    );
  ...
  const deleteCaseStudy = () => {
    Axios.delete(`https://razor-edge-app.herokuapp.com/case-studies-get/${caseStudy._id}`);
    navigate("/admin-case-studies");
  };
