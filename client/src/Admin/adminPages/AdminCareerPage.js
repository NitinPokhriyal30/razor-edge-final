...
//   useEffect(() => {
//     Axios.get("https://razor-edge-app.herokuapp.com/career").then((res) =>
//     setCareer(res.data)
//     );
//   }, []);
...
const AdminCareerPage = () => {
  ...
  useEffect(() => {
    const get = async () => { 
      ...
      await Axios.get(
        "https://razor-edge-app.herokuapp.com/development-jobs"
      ).then((res) => setDevelopment(res.data));

      await Axios.get(
        "https://razor-edge-app.herokuapp.com/management-jobs"
      ).then((res) => setManagement(res.data));

      await Axios.get(
        "https://razor-edge-app.herokuapp.com/operation-jobs"
      ...
      const res = await Axios.get(
        "https://razor-edge-app.herokuapp.com/careers"
      );
      res.data.map((value) => {
  ...
  //   await Axios.put("https://razor-edge-app.herokuapp.com/career", formData);
  ...
  const updateData = async () => {
    ...
    await Axios.put("https://razor-edge-app.herokuapp.com/careers", data);
    window.location.reload();
  };
    ...
    <>
      ...
      <div className="career-img-container">
        {update ? (
          ...
          <img
            src={`https://razor-edge-app.herokuapp.com/images/${sec1img1}`}
