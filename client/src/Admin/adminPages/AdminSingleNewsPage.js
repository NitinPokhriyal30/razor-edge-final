...
const AdminSingleNewsPage = () => {
  ...
  useEffect(() => {
    const getNews = async () => {
      const res = await Axios.get("https://razor-edge-app.herokuapp.com/news-get/" + id);
      setNews(res.data);
  ...
  const updateData = async () => {
    ...
    Axios.put(`https://razor-edge-app.herokuapp.com/news-get/${news._id}`, formData);
    navigate("/admin-news");
  };

  const deleteNews = () => {
    Axios.delete(`https://razor-edge-app.herokuapp.com/news-get/${news._id}`).then((res) =>
      navigate("/admin-news")
    );
  };
