...
const AdminHomePage = (props) => {
  ...
  // useEffect(() => {
  //   Axios.get("https://razor-edge-app.herokuapp.com/solution2-get").then((res) =>
  ...
  const updateData = async (e) => {
    ...
    await Axios.put(
      "https://razor-edge-app.herokuapp.com/home-update",
      formData
    );
                        ...
                        update ? (
                          ...
                          <div className="player-wrapper">
                            <ReactPlayer
                              ...
                              url={`https://razor-edge-app.herokuapp.com/images/${herovideoimage1}`}
                            />
                          </div>
                        )
                      ) : update ? (
              ...
              <div className=" col-lg-6 m-auto">
                <div className="bullet-img-sec">
                  {update ? (
                    ...
                    <img
                      src={`https://razor-edge-app.herokuapp.com/images/${bulletimage1}`}
                  ...
                  <div className="col-md-6 m-auto text-center ">
                    <div className="solution-img-container">
                      {update ? (
                        ...
                        <img
                          src={`https://razor-edge-app.herokuapp.com/images/${solutionimage1}`}
                          className="Solution"
                          alt="Solution"
                        />
                      )}
              ...
              <div className="our-solution-head ">
                ...
                <div className="product-img-conatiner">
                  {update ? (
                    ...
                    <img
                      src={`https://razor-edge-app.herokuapp.com/images/${proSecmainimage1}`}
                      className="product"
                      alt="product"
                    />
                  )}
