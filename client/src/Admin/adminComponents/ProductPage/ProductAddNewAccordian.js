...
const ProductAddNewAccordian = () => {
  ...
  useEffect(() => {
    const get = async () => {
      const res = await Axios.get("https://razor-edge-app.herokuapp.com/product-get/" + id);
  ...
  const updateData = () => {
    ...
    Axios.put(`https://razor-edge-app.herokuapp.com/product-update/${id}`, newdata).then(
