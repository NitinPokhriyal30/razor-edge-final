...
//     await Axios.put("https://razor-edge-app.herokuapp.com/product-update", formData);
...
//     };
//     Axios.put(`https://razor-edge-app.herokuapp.com/product-update/${props.id}`, newdata).then(
