...
const SingleTestimonial = () => {
  ...
  useEffect(() => {
    const getData = async () => {
      const res = await Axios.get("https://razor-edge-app.herokuapp.com/testimonial/" + id);
      setData(res.data);
      setImg(res.data.img);
  ...
  const updateData = async () => {
    ...
    Axios.put(`https://razor-edge-app.herokuapp.com/testimonial/${data._id}`, formData);
    navigate("/admin-dashboard");
  };

  const deleteData = () => {
    Axios.delete(`https://razor-edge-app.herokuapp.com/testimonial/${data._id}`);
    navigate("/admin-dashboard");
  }
