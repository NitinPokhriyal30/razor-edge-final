    ...
    useEffect(() => {
        const getData = async () => {
          const res = await Axios.get(
            "https://razor-edge-app.herokuapp.com/career-gallery/" + id 
          );
          setImg(res.data.img);
        };
        getData();
      ...
      const updateData = () => {
        ...
        Axios.put(`https://razor-edge-app.herokuapp.com/career-gallery/${id}`, formData);
        navigate("/admin-career");
      };

      const deleteData = () => {
        Axios.delete(`https://razor-edge-app.herokuapp.com/career-gallery/${id}`);
        navigate("/admin-career");
      };
