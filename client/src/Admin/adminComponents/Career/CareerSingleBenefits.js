...
const CareerSingleBenefits = () => {
    ...
    useEffect(() => {
        const getBlog = async () => {
            const res = await Axios.get("https://razor-edge-app.herokuapp.com/benefits/" + id);  
    ...
    const updateData = async () => {
        ...
        Axios.put(`https://razor-edge-app.herokuapp.com/benefits/${benefits._id}`, formData);    
        navigate("/admin-career");
    };

    // const deleteData = () => {
    //     Axios.delete(`https://razor-edge-app.herokuapp.com/benefits/${benefits._id}`);
    //     navigate("/admin-career");
    // };
