...
const ClientSingleGalleryPage = () => {
    ...
    useEffect(() => {
      const getGallery = async () => {
        const res = await Axios.get("https://razor-edge-app.herokuapp.com/clientgallery/" + id); 
        setGallery(res.data);
  ...
  const updateData = async (e) => {
    e.preventDefault();
      ...
      Axios.put(`https://razor-edge-app.herokuapp.com/clientgallery/${gallery._id}`, formData);   
      navigate("/admin-client");
    };

  const deleteGallery = (e) => {
      e.preventDefault();
      Axios.delete(`https://razor-edge-app.herokuapp.com/clientgallery/${gallery._id}`);
      navigate("/admin-client");
    };
