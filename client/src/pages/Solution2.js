  ...
  useEffect(() => {
    const get = async () => { 
      const res = await Axios.get(
        "https://razor-edge-app.herokuapp.com/solution2-get/" + id
      );
      setData(res.data);
          ...
          <div className="row">
            <div className=" col-lg-6 col-md-6 integration-data-col pb-3">
              <div className="bullet-img-sec">
                <img
                  src={`https://razor-edge-app.herokuapp.com/images/${data.sol2FirstImage}`}
                  className="whyUs"
                  alt="whyUs"
                />
              </div>
        ...
        <div className="container">
          <div className="row">
            <div className=" col-lg-6 col-md-6 integration-data-col">
              <div className="bullet-img-sec">
                <img
                  src={`https://razor-edge-app.herokuapp.com/images/${data.sol2ThirdImage}`}
          ...
          <div className="row product-comp-rw">
            ...
            >
              <div className="product-first-img">
                <img
                  src={`https://razor-edge-app.herokuapp.com/images/${data.sol1Fifthcard1Image}`}
            ...
            >
              <div className="product-first-img">
                <img
                  src={`https://razor-edge-app.herokuapp.com/images/${data.sol1Fifthcard2Image}`}
            ...
            >
              <div className="product-first-img">
                <img
                  src={`https://razor-edge-app.herokuapp.com/images/${data.sol1Fifthcard3Image}`}
            ...
            >
              <div className="product-first-img">
                <img
                  src={`https://razor-edge-app.herokuapp.com/images/${data.sol1Fifthcard4Image}`}
