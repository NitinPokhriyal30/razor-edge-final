...
const Home = () => {
  ...
  useEffect(() => {
    ...
    Axios.get("https://razor-edge-app.herokuapp.com/why-razor-edge-get").then((res) =>
    setWhyRazorEdge(res.data),
    );

    Axios.get("https://razor-edge-app.herokuapp.com/solution2-get/get-all").then((res) =>
      setData(res.data) 
    );
          ...
          <div className="row product-comp-rw">
            ...
            >
              <div className="product-first-img">
                <img
                  src={`https://razor-edge-app.herokuapp.com/images/${value.sol1Fifthcard1Image}`}
            ...
            >
              <div className="product-first-img">
                <img
                  src={`https://razor-edge-app.herokuapp.com/images/${value.sol1Fifthcard2Image}`}
            ...
            >
              <div className="product-first-img">
                <img
                  src={`https://razor-edge-app.herokuapp.com/images/${value.sol1Fifthcard3Image}`}
            ...
            >
              <div className="product-first-img">
                <img
                  src={`https://razor-edge-app.herokuapp.com/images/${value.sol1Fifthcard4Image}`}
